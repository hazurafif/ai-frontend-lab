    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="inset-x-0 bottom-0 top-auto data-[side=bottom]:h-[70dvh] max-h-[85dvh] w-full rounded-t-2xl border-t border-border/30 bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden"
        ...
        >
          ...
          <div className="flex h-full w-full flex-col overflow-y-auto pt-2 pb-[env(safe-area-inset-bottom)]">
            {children}
          </div>
        </SheetContent>
      </Sheet>
