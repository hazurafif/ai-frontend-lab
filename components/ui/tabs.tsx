...
function Tabs({
  ...
  return (
    <TabsPrimitive.Root
      ...
      // Base UI only sets data-orientation; the shadcn styles key off
      // data-horizontal/data-vertical, so set them explicitly.
